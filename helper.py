...
def medal_tally(df):
    ...
    medal_rally['Gold'] = medal_rally['Gold'].astype('int')
    medal_rally['Silver'] = medal_rally['Silver'].astype('int')
    medal_rally['Bronze'] = medal_rally['Bronze'].astype('int')
    medal_rally['total'] = medal_rally['total'].astype('int')
